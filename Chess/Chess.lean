...
def Coords_test01 :Coords where
  row := 5
  col := 5
...
#eval Coords_test01 -- { row := 5, col := 5 }
#eval Coords.up Coords_test01 -- some { row := 4, col := 5 }
...
#eval Coords_test01 -- { row := 5, col := 5 }
#eval Coords.up Coords_test01 -- some { row := 4, col := 5 }
#eval Coords.ul Coords_test01 -- some { row := 4, col := 4 }
...
#eval Coords.up Coords_test01 -- some { row := 4, col := 5 }
#eval Coords.ul Coords_test01 -- some { row := 4, col := 4 }
#eval Coords.nm1 Coords_test01 -- some { row := 4, col := 3 }
